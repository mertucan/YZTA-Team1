...
from app.routers import companies, dashboard, universities, users, menu_assignments, auth
...
app.include_router(menu_assignments.router, prefix="/api")
...
def on_startup():
    ...
    from app.models import RoleModel, Role, Company, License, UserProfile, University
