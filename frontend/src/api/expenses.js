...
export const getMaterialExpenses = (month)  => client.get("/expenses/materials", { params: month ? { month } : {} }).then((r) => r.data);
export const getBudgetCheck = (month)       => client.get("/expenses/budget-check", { params: month ? { month } : {} }).then((r) => r.data);
